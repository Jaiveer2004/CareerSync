export function BookingPageSkeleton() {
  return (
    <main className="container mx-auto py-8 pt-24 px-4">
      {/* Header Skeleton */}
      <div className="mb-8">
        <div className="flex items-center gap-2 text-slate-500 text-sm mb-4 animate-pulse">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl p-8 border border-slate-200 mb-6 animate-pulse">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-1">
                  <div className="h-10 bg-slate-100 rounded-lg mb-2 w-3/4"></div>
                  <div className="flex items-center gap-4">
                    <div className="h-6 bg-[#1e40af]/20 rounded-full w-20"></div>
                    <div className="h-4 bg-slate-100 rounded w-16"></div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="h-8 bg-slate-100 rounded-lg w-24 mb-1"></div>
                  <div className="h-4 bg-slate-100 rounded w-16"></div>
                </div>
              </div>

              <div className="mb-6">
                <div className="h-6 bg-slate-100 rounded-lg mb-3 w-48"></div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden animate-pulse">
              ...
              <div className="p-6 space-y-6">
                ...
                {/* Submit Button */}
                <div className="h-12 bg-[#1e40af] rounded-xl w-full"></div>
              </div>
            </div>
          </div>
        </div>
