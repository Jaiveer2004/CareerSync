...
export function ChatWindow({ onClose }: ChatWindowProps) {
  const [messages, setMessage] = useState<Message[]>([
    { sender: 'ai', text: 'Hi! I\'m your CareerSync AI assistant. Ask me about any home services you need! 😊' }
  ]);
    ...
    <div className="flex flex-col h-[500px] w-[380px] bg-slate-50 rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-white font-semibold">CareerSync Assistant</h3>
