    ...
    <ProtectedRoute>
      <DashboardLayout>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 bg-slate-50/50 min-h-screen">
          ...
          {user?.role === 'partner' && stats && stats.hasCompanyProfile === false ? (
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 border border-slate-200/80 shadow-md text-center max-w-2xl mx-auto my-8 space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-bold text-slate-900 font-serif">Complete Employer Onboarding</h3>
                <p className="text-slate-500 text-sm max-w-md mx-auto leading-relaxed">
                  Set up your company profile to start posting tech roles, receiving applications, and utilizing AI-driven match scoring.
                </p>
              </div>
              <div className="pt-2">
                <Link href="/employer/onboard">
                  <Button className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 px-6 rounded-xl shadow-md transition-all">
